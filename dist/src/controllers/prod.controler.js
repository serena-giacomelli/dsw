...
async function add(req, res) {
    try {
        const producto = new Producto(req.body.nombre, req.body.cantidad, req.body.descripcion, req.body.id, req.body.id_tipo_producto);
...
//# sourceMappingURL=prod.controler.js.map