...
const EmpresaDetail: React.FC = () => {
    ...
    const fetchEmpresaYMarcas = async () => {
        ...
        try {
            ...
            const resEmp = await fetch(`/api/empresa/${id}`);
    ...
    const saveMarca = async () => {
        ...
        if (editingMarca) {
            // Update
            await fetch(`/api/marca/${editingMarca.id}`, {
                method: "PUT",
    ...
    const deleteMarca = async () => {
        ...
        await fetch(`/api/marca/${marcaToDelete.id}`, { method: "DELETE" });
    ...
    const saveSucursal = async () => {
        ...
        if (editingSucursal.sucursal) {
            // Update
            await fetch(`/api/sucursal/${editingSucursal.sucursal.id}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
            ...
            await fetch(`/api/marca/${editingSucursal.marcaId}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    sucursales: [
    ...
    const deleteSucursal = async () => {
        ...
        if (marca) {
            ...
            await fetch(`/api/marca/${marca.id}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
        ...
        // await fetch(`/api/sucursal/${sucursalToDelete.sucursal.id}`, { method: "DELETE" });
